...
const css = {
	code: ".grid.svelte-mjwerd.svelte-mjwerd{display:grid;grid-template-columns:repeat(3, 1fr);grid-column-gap:10px;grid-row-gap:10px}.grid.svelte-mjwerd .grid-item.svelte-mjwerd{display:flex;flex-grow:1;height:180px;padding:10px;align-items:center;justify-content:center;background:var(--primary);font-weight:bold;border-radius:5px;color:white;text-align:center}a.svelte-mjwerd.svelte-mjwerd::before{content:none}",
